...
function VbsDecoder() {
    ...
    this.decodeInit = function(value, i) {
        ...
        // console.log(this.dec.hStart,"###", this.dec.encodeData.toString())
    ...
    this._left = function() {
        if (this.dec.maxLength > 0) {
            return (this.dec.maxLength - this.dec.pos) + parseInt(this.dec.hEnd - this.dec.hStart);
        }
