...
function testVbsKeyVal() {
    ...
    // let arr = [2,128,27,1]; // [ Uint8Array [  ] ]
    // let arr = [217,64]; // 89
    // let arr = [129,30,128,65]; // Math.pow(2,128)
    // let arr = [184,119];
    // let arr = [24]
    // let arr = [15] // null
    // let arr = [134,27,1,2,3,4,5,6]  // Uint8Array [ 1, 2, 3, 4, 5, 6 ]
    // let arr = [38,228,184,173,229,155,189]; // 中国
    // let arr = [134,27,89,89,76,0,0,0] // Uint8Array [ 89, 89, 76, 0, 0, 0 ]
    let arr = [2,217,30,64,217,30,64,147,30,66,1]; //[ 89, 89, 76 ]
    // let arr = [2,205,153,179,230,204,153,179,134,30,183,96,205,153,179,230,204,153,179,134,30,182,96,179,230,204,153,179,230,204,137,30,182,96,1]; // [ 0.1, 0.2, 0.3 ]
